...
const OldSchoolPortfolio = () => {
  const portfolioData = {
    ...
    metaTitle: "Portfolio Tatuaggi Old School Torino | Galleria Kingdom Ink",
    metaDescription:
      "Guarda il portfolio completo di tatuaggi Old School realizzati a Torino da Simone Sorrentino. Stile tradizionale americano con linee bold e colori brillanti. 20+ lavori.",
    ...
    gallery: [
      {
        ...
        alt: "Tatuaggio Old School con ancora e rondini realizzato a Torino da Kingdom Ink",
