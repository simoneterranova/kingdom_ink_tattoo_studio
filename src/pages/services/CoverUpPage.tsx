...
const CoverUpPage = () => {
  const styleData = {
    ...
    metaTitle: "Cover up e correzioni tatuaggi - Kingdom Ink",
    metaDescription:
      "Se hai un vecchio tatuaggio che non ti rappresenta più, o se desideri trasformare un tatuaggio poco riuscito in un'opera d'arte, Kingdom Ink è specializzato nel cover-up di tatuaggi a Torino.",
    h1: "Cover-up di Vecchi Tatuaggi",
    intro:
      "Se hai un vecchio tatuaggio che non ti rappresenta più, o se desideri trasformare un tatuaggio poco riuscito in un'opera d'arte, sei nel posto giusto. Kingdom Ink è specializzato nel cover-up di tatuaggi a Torino, creando nuovi disegni che non solo coprono, ma arricchiscono e rinnovano la tua pelle con creatività e precisione.",
    about: [
      "Un cover-up non è solo una semplice copertura di un tatuaggio esistente, ma un processo artistico che richiede attenzione e conoscenza tecnica. Simone Sorrentino esamina il tuo tatuaggio attuale, valuta le sue caratteristiche (come i colori, la forma e la posizione), e sviluppa un nuovo design che si integra perfettamente con il lavoro precedente, senza compromettere la qualità e l'estetica.",
      "Kingdom Ink si dedica alla creazione di tatuaggi personalizzati che raccontano storie uniche. Specializzato nella tecnica del cover-up, trasforma vecchi tatuaggi in opere d'arte contemporanee. Ogni cover-up che realizza è studiato con precisione, per garantire che la nuova creazione non solo copra il vecchio disegno, ma lo renda parte di una nuova storia.",
    ...
    process: [
      ...
      "Valutazione tecnica: Simone Sorrentino esamina caratteristiche come colori, forma e posizione.",
