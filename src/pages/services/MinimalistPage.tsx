...
const MinimalistPage = () => {
  const styleData = {
    ...
    metaTitle: "Tatuaggio Minimalista a Torino | Kingdom Ink | Essenziale ed Elegante",
    metaDescription:
      "Tatuaggi minimalisti a Torino. Design essenziali, linee pulite, simboli semplici. Studio Kingdom Ink. Eleganza discreta. Prenota consulenza gratuita.",
    ...
    about: [
      ...
      "Kingdom Ink realizza tatuaggi minimalisti con precisione assoluta, utilizzando linee sottili e pulite che richiedono mano ferma ed esperienza. Ogni design è studiato per mantenere la sua chiarezza e leggibilità nel tempo."
    ],
    features: [
    ...
    gallery: [
      { src: "/images/tatuaggi/Minimal-tattoo-1.jpg", alt: "Tatuaggio Minimalista discreto - Kingdom Ink Torino" }
    ],
    relatedStyles: [
    ...
    faqs: [
      {
        ...
        answer: "Sì, ma poiché le linee sottili tendono a sbiadire più facilmente rispetto ad altri stili, è fondamentale scegliere un tatuatore esperto come Kingdom Ink, che utilizza tecniche precise per garantire la massima durata."
      },
      {
      ...
      },
      {
        ...
        answer: "Assolutamente sì! Simone Sorrentino lavora con ogni cliente per creare un disegno su misura, combinando semplicità ed espressività."
      }
    ]
  };
