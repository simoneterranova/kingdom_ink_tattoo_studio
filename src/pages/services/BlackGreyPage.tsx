...
const BlackGreyPage = () => {
  const styleData = {
    ...
    metaTitle: "Tatuaggio Black & Grey a Torino - Kingdom Ink",
    metaDescription:
      "Il tatuaggio Black and Grey rappresenta l'arte della sfumatura e del chiaroscuro, uno stile senza tempo che esprime forza, emozione e realismo. Kingdom Ink realizza tatuaggi Black and Grey a Torino con un'attenzione maniacale ai dettagli.",
    h1: "Black & Grey Tattoo a Torino",
    intro:
      "Il tatuaggio Black and Grey rappresenta l'arte della sfumatura e del chiaroscuro, uno stile senza tempo che esprime forza, emozione e realismo. Kingdom Ink realizza tatuaggi Black and Grey a Torino con un'attenzione maniacale ai dettagli, trasformando ogni disegno in un'opera d'arte che resiste al tempo. Se cerchi un tatuaggio dal forte impatto visivo, capace di raccontare una storia attraverso il contrasto tra luce e ombra, sei nel posto giusto.",
    about: [
      "Lo stile Black and Grey nasce dall'utilizzo esclusivo dell'inchiostro nero, diluito in diverse gradazioni di grigio per creare profondità e tridimensionalità. Questa tecnica è ideale per tatuaggi realistici, ritratti, soggetti religiosi e motivi dettagliati, offrendo un effetto sofisticato e intenso. Kingdom Ink utilizza tecniche avanzate per ottenere sfumature fluide e omogenee, assicurando un risultato armonioso e duraturo.",
    ...
    process: [
      "Consulenza iniziale: Simone Sorrentino lavora con i clienti per sviluppare disegni personalizzati, traducendo ogni idea in un'opera unica.",
    ...
    gallery: [
      { src: shopConfig.gallery[1].src, alt: "Tatuaggio black and grey realistico - Kingdom Ink Torino" }
    ],
    relatedStyles: [
