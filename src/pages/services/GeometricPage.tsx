...
const GeometricPage = () => {
  const styleData = {
    ...
    metaTitle: "Tatuaggio geometrico a Torino - Kingdom Ink",
    metaDescription:
      "Il tatuaggio geometrico è l'incontro tra arte, matematica e simbolismo. Linee perfette, figure astratte e motivi complessi. Kingdom Ink realizza tatuaggi geometrici a Torino con una precisione assoluta.",
    h1: "Tatuaggio geometrico a Moncalieri (Torino)",
    intro:
      "Il tatuaggio geometrico è l'incontro tra arte, matematica e simbolismo. Linee perfette, figure astratte e motivi complessi si intrecciano per creare tatuaggi dal forte impatto visivo e dal significato profondo. Kingdom Ink realizza tatuaggi geometrici a Torino con una precisione assoluta, studiando ogni composizione per valorizzare al massimo l'armonia delle forme e l'anatomia del corpo.",
    about: [
      ...
      "La realizzazione di un tatuaggio geometrico richiede massima precisione e una mano ferma. Kingdom Ink utilizza tecniche avanzate per garantire che ogni linea sia nitida e perfettamente bilanciata. L'attenzione ai dettagli è fondamentale per ottenere un tatuaggio che mantenga la sua pulizia e definizione nel tempo.",
      "Per Kingdom Ink, il tatuaggio geometrico è un'arte di precisione. Ogni progetto è eseguito con cura millimetrica per garantire simmetria e armonia. Grazie all'utilizzo di strumenti all'avanguardia e alla sua esperienza artistica, riesce a creare tatuaggi con linee impeccabili e design che si adattano perfettamente alle curve del corpo."
    ],
    features: [
    ...
    process: [
      "Consulenza iniziale: Simone Sorrentino lavora con ogni cliente per sviluppare un design su misura, studiando l'equilibrio delle forme e l'effetto ottico sulla pelle.",
    ...
    gallery: [
      { src: shopConfig.gallery[2].src, alt: "Tatuaggio geometrico con mandala - Kingdom Ink Torino" }
    ],
    relatedStyles: [
