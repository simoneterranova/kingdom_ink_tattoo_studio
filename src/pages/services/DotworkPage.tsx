...
const DotworkPage = () => {
  const styleData = {
    ...
    metaTitle: "Tatuaggio Dotwork a Torino | Kingdom Ink | Tecnica Puntinata",
    metaDescription:
      "Tatuaggi dotwork a Torino. Tecnica raffinata a punti per ombreggiature e texture uniche. Studio Kingdom Ink, maestria e precisione. Prenota consulenza.",
    ...
    about: [
      ...
      "Kingdom Ink, nel suo studio a Torino, realizza tatuaggi dotwork con maestria e attenzione ai dettagli, trasformando la pelle in un'opera d'arte fatta di pazienza, precisione e armonia visiva."
    ],
    features: [
    ...
    process: [
      "Consulenza iniziale: Simone Sorrentino ascolta le tue idee e ti mostra esempi di dotwork per aiutarti a visualizzare il risultato finale.",
    ...
    gallery: [
      { src: "/images/styles/tatuaggio-dotwork-a-torino/Gran-Babar-torino.jpg", alt: "Tatuaggio Dotwork geometrico - Kingdom Ink Torino" }
    ],
    relatedStyles: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "Il processo si basa su strumenti di precisione e l'uso di inchiostri di alta qualità. Kingdom Ink unisce metodi tradizionali e innovativi, concentrandosi sulla corretta disposizione dei puntini per ottenere disegni nitidi e gradazioni armoniose."
      },
      {
      ...
      {
        question: "Perché scegliere Kingdom Ink per il tuo tatuaggio dotwork a Torino?",
        answer: "Scegliere Kingdom Ink significa affidarsi a un'esperienza artistica consolidata, a una passione per l'arte e a un approccio personalizzato che trasforma ogni tatuaggio in un'opera unica. La professionalità, l'attenzione al dettaglio e l'innovazione tecnologica fanno di ogni consultazione un percorso di scoperta e creazione artistica."
      }
    ]
  };
