...
const NewSchoolPage = () => {
  const styleData = {
    ...
    metaTitle: "Tatuaggio New School a Torino - Kingdom Ink",
    metaDescription:
      "Se sei alla ricerca di un tatuaggio che unisca espressività, colori accesi e linee dinamiche, lo stile New School è la scelta perfetta. Kingdom Ink realizza tatuaggi New School a Torino, trasformando idee in opere d'arte uniche.",
    h1: "New School Tattoo a Moncalieri (Torino)",
    intro:
      "Se sei alla ricerca di un tatuaggio che unisca espressività, colori accesi e linee dinamiche, lo stile New School è la scelta perfetta. Kingdom Ink realizza tatuaggi New School a Torino, trasformando idee in opere d'arte uniche, con uno stile audace e inconfondibile.",
    about: [
    ...
    gallery: [
      { src: "/images/tatuaggi/new-school.jpg", alt: "Tatuaggio New School colorato - Kingdom Ink Torino" }
    ],
    relatedStyles: [
    ...
    faqs: [
      { question: "Il tatuaggio New School si rovina più facilmente per via dei colori accesi?", answer: "No, con una corretta cura post-tatuaggio e protezione dal sole, i colori rimangono vividi nel tempo. Kingdom Ink utilizza pigmenti di alta qualità per garantire una durata eccellente." },
      { question: "Posso portare un mio disegno e farlo reinterpretare in stile New School?", answer: "Assolutamente sì! Simone Sorrentino lavora sempre sulla personalizzazione, adattando qualsiasi idea allo stile New School, per un risultato unico e su misura." },
      { question: "Il tatuaggio New School può essere combinato con altri stili?", answer: "Sì! È possibile integrare elementi realistici, tradizionali o surrealisti per creare un mix originale e creativo. Simone Sorrentino può consigliarti la soluzione migliore per un risultato armonioso." }
    ]
  };
