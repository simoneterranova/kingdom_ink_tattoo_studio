...
const WatercolorPage = () => {
  const styleData = {
    ...
    metaTitle: "Tatuaggio Watercolor a Torino | Kingdom Ink | Effetto Acquerello",
    metaDescription:
      "Tatuaggi watercolor a Torino. Effetto acquerello, colori sfumati, pennellate artistiche. Studio Kingdom Ink. Arte pittorica sulla pelle. Prenota consulenza.",
    ...
    about: [
      ...
      "Kingdom Ink realizza tatuaggi watercolor con tecnica raffinata, utilizzando sfumature morbide e transizioni di colore che richiedono grande maestria. Ogni tatuaggio viene studiato per mantenere la sua vibrazione cromatica nel tempo."
    ],
    features: [
    ...
    gallery: [
      { src: "/images/styles/tatuaggio-watercolor-a-torino/Watercolor.jpg", alt: "Tatuaggio Watercolor artistico - Kingdom Ink Torino" }
    ],
    relatedStyles: [
    ...
    faqs: [
      ...
      {
        question: "Perché scegliere Kingdom Ink per il tuo tatuaggio Watercolor a Torino?",
        answer: "Scegliere Kingdom Ink significa affidarsi a esperienza artistica consolidata e a una passione per l'arte che si traduce in tatuaggi Watercolor unici e personalizzati. La mia attenzione ai dettagli, l'uso di tecnologie all'avanguardia e un approccio empatico assicurano risultati che non solo incantano per la loro bellezza, ma raccontano storie e emozioni in modo autentico e duraturo."
      }
    ]
  };
