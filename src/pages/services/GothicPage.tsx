...
const GothicPage = () => {
  const styleData = {
    ...
    metaTitle: "Tatuaggio Gotico a Torino | Kingdom Ink | Stile Dark ed Elegante",
    metaDescription:
      "Tatuaggi gotici a Torino. Teschi, rose nere, architetture gotiche, blackletter. Studio Kingdom Ink. Atmosfera dark ed elegante. Prenota consulenza.",
    h1: "Tatuaggio Gotico a Moncalieri (Torino)",
    intro:
    ...
    about: [
      ...
      "Kingdom Ink interpreta lo stile gotico con sensibilità artistica, creando tatuaggi che bilanciano l'oscurità con l'eleganza, il macabro con il bello, risultando in opere che celebrano l'estetica gotica in tutte le sue sfumature."
    ],
    features: [
    ...
    process: [
      ...
      "Design elaborato: Simone Sorrentino lavora sui dettagli ornamentali che rendono unico ogni tatuaggio gotico.",
    ...
    gallery: [
      { src: "/images/styles/tatuaggio-gotico-a-torino/gotico-1.jpg", alt: "Tatuaggio Gotico elegante - Kingdom Ink Torino" }
    ],
    relatedStyles: [
    ...
    faqs: [
      ...
      { question: "Quali tecniche vengono utilizzate per realizzare un tatuaggio gotico?", answer: "Kingdom Ink utilizza una combinazione di tecniche tradizionali e moderne, impiegando strumenti di precisione e inchiostri di alta qualità per ottenere tratti definiti e sfumature armoniose, esaltando il carattere simbolico del design." }
    ]
  };
