...
const RealisticPage = () => {
  const styleData = {
    ...
    metaTitle: "Tatuaggio realistico a Torino - Kingdom Ink",
    metaDescription:
      "Il tatuaggio realistico è la massima espressione tecnica dell'arte del tatuaggio. Basato sulla precisione dei dettagli e sull'uso sapiente delle sfumature. Kingdom Ink è un punto di riferimento per chi desidera un tatuaggio realistico a Torino.",
    h1: "Tatuaggio realistico a Moncalieri (Torino)",
    intro:
      "Il tatuaggio realistico è la massima espressione tecnica dell'arte del tatuaggio. Basato sulla precisione dei dettagli e sull'uso sapiente delle sfumature, questo stile consente di riprodurre immagini fedeli alla realtà, dai ritratti umani agli animali, dagli elementi naturali ai paesaggi. Kingdom Ink è un punto di riferimento per chi desidera un tatuaggio realistico a Torino, realizzato con cura, esperienza e una profonda sensibilità artistica.",
    about: [
    ...
    process: [
      ...
      "Design personalizzato: Simone Sorrentino lavora in stretta collaborazione con ogni cliente per creare un'opera su misura, che racconti una storia e trasmetta emozione.",
    ...
    gallery: [
      { src: shopConfig.gallery[1].src, alt: "Tatuaggio realistico black and grey - Kingdom Ink Torino" }
    ],
    relatedStyles: [
    ...
    faqs: [
      ...
      { question: "Meglio un tatuaggio realistico in Black and Grey o a colori?", answer: "Entrambe le versioni hanno il loro fascino. Il Black and Grey è più classico e duraturo, mentre il colore dona un effetto più vivido e d'impatto. Simone Sorrentino aiuta ogni cliente a scegliere la soluzione più adatta alle proprie preferenze." }
    ]
  };
