...
const JapanesePage = () => {
  const styleData = {
    ...
    metaTitle: "Tatuaggio Giapponese Irezumi a Torino | Kingdom Ink | Tradizione Nipponica",
    metaDescription:
      "Tatuaggi giapponesi Irezumi a Torino. Draghi, carpe koi, fiori di ciliegio. Tradizione e significato. Studio Kingdom Ink. Prenota consulenza.",
    ...
    about: [
      ...
      "Oggi, il tatuaggio giapponese continua a rappresentare forza, onore e resistenza, mantenendo un forte legame con la cultura e la tradizione nipponica. Kingdom Ink, con il suo rispetto per la tradizione, realizza tatuaggi giapponesi a Torino con un'attenta ricerca stilistica e una tecnica impeccabile.",
    ...
    gallery: [
      { src: "/images/styles/tatuaggio-giapponese-irezumi-a-torino/giapponese.jpg", alt: "Tatuaggio Giapponese Irezumi - Kingdom Ink Torino" }
    ],
    relatedStyles: [
